<template>
  <div class="min-h-screen mt-[70px]">
    <nav class="container mx-auto px-4 pt-4 text-sm text-gray-500 dark:text-gray-400">
      ...
      <span class="mx-2">/</span>
      <span>All Terrain Telescopic Crane</span>
    </nav>

    <section class="relative py-20 px-4 bg-gray-50 dark:bg-zinc-900/50 mt-4">
      <div class="max-w-4xl mx-auto text-center">
        <h1 class="text-4xl md:text-5xl font-bold leading-tight mb-6">
          All Terrain Telescopic Crane on Rent in
          <span class="text-[#FF4057]">Navi Mumbai</span> | 50T to 700T
        </h1>
        <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
          Saini Lifters provides all terrain telescopic cranes on rent in Navi Mumbai, Panvel, Kalamboli and pan-India.
          Our XCMG QAY series (160T–300T) and heavy lift cranes up to 700T are available 24/7 with certified operators
          for bridge construction, power plant erection and mega industrial projects.
        </p>
    ...
    <section class="max-w-5xl mx-auto px-4 py-12">
      <div class="w-full rounded-xl overflow-hidden mb-12 bg-gray-50 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700">
        <img src="/image/eq-all-terrain-crane.png" alt="All terrain telescopic crane 700T on rent in Navi Mumbai — Saini Lifters" class="w-full h-auto object-contain max-h-[480px] mx-auto p-4" loading="eager" />
      </div>

      <h2 class="text-3xl font-bold mb-8">Our All Terrain Crane Fleet</h2>
    ...
    <section class="py-16 bg-[#FF4057]/5 dark:bg-[#FF4057]/10">
      <div class="max-w-3xl mx-auto text-center px-4">
        <h2 class="text-3xl font-bold mb-4">Book All Terrain Crane in Navi Mumbai</h2>
        <p class="text-gray-500 dark:text-gray-300 mb-6">
          Also see:
          <NuxtLink to="/services/all-terrain-crane-rental" class="text-[#FF4057] hover:underline">All-Terrain Crane Service</NuxtLink> |
          ...
          <NuxtLink to="/equipment/crawler-crane" class="text-[#FF4057] hover:underline">Crawler Crane</NuxtLink>
        </p>
        <div class="flex flex-wrap gap-4 justify-center">
          <a href="tel:+919322296990" class="bg-[#FF4057] hover:bg-red-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors">Call: +91 9322296990</a>
          <a href="https://wa.me/919322296990?text=Hi%20I%20need%20all%20terrain%20crane%20on%20rent%20in%20Navi%20Mumbai" class="border-2 border-[#FF4057] text-[#FF4057] hover:bg-[#FF4057] hover:text-white px-8 py-3 rounded-lg font-semibold transition-colors">WhatsApp Us</a>
        </div>
      </div>
    </section>
  </div>
...
useHead({
  title: "All Terrain Telescopic Crane on Rent in Navi Mumbai | 50T to 700T | Saini Lifters",
  meta: [
    { name: "description", content: "All terrain telescopic crane on rent in Navi Mumbai. XCMG QAY160 (160T), QAY300 (300T) and 700T heavy lift cranes with certified operators. 24/7 availability. Call +91 9322296990." },
    { name: "robots", content: "index, follow" },
    { name: "keywords", content: "all terrain crane on rent navi mumbai, telescopic crane rental navi mumbai, XCMG crane navi mumbai, 300T crane rental navi mumbai, heavy lift crane navi mumbai" },
    { property: "og:url", content: "https://www.sainilifters.com/equipment/all-terrain-crane" },
    { property: "og:title", content: "All Terrain Telescopic Crane on Rent in Navi Mumbai | 50T–700T" },
    { property: "og:description", content: "All terrain crane on rent in Navi Mumbai. XCMG 160T–300T and 700T cranes available 24/7. Call +91 9322296990." },
    { property: "og:image", content: "https://www.sainilifters.com/image/eq-all-terrain-crane.png" },
  ],
  link: [{ rel: "canonical", href: "https://www.sainilifters.com/equipment/all-terrain-crane" }],
  script: [
    {
      type: "application/ld+json",
      innerHTML: JSON.stringify({
        "@context": "https://schema.org", "@type": "Service",
        "name": "All Terrain Telescopic Crane Rental",
        "provider": { "@type": "LocalBusiness", "name": "Saini Lifters Crane Service", "telephone": "+91-9322296990", "url": "https://www.sainilifters.com" },
        "areaServed": ["Navi Mumbai", "Panvel", "Kalamboli", "Raigad", "Mumbai", "Thane", "Maharashtra", "Odisha", "Madhya Pradesh"],
        "url": "https://www.sainilifters.com/equipment/all-terrain-crane",
        "description": "All terrain telescopic crane rental — XCMG QAY160 to 700T heavy lift cranes with certified operators, 24/7 availability from Kalamboli, Navi Mumbai."
      }),
    },
    {
      type: "application/ld+json",
      innerHTML: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Equipment", item: "https://www.sainilifters.com/equipment" },
          { "@type": "ListItem", position: 3, name: "All Terrain Telescopic Crane", item: "https://www.sainilifters.com/equipment/all-terrain-crane" },
        ],
      }),
    },
    {
...
const cranes = [
  { name: "XCMG QAY160 — 160 Tonnes", desc: "Versatile all-terrain crane for construction, industrial and civil projects across Navi Mumbai, Panvel and Raigad.", specs: [{ label: "Capacity", value: "160T" }, { label: "Main Boom", value: "78m" }, { label: "JIB", value: "21m" }, { label: "Total Reach", value: "162m" }] },
  { name: "XCMG QAY300 — 300 Tonnes", desc: "Our most powerful crane for bridge construction, power plants and mega projects across Navi Mumbai and Maharashtra.", specs: [{ label: "Capacity", value: "300T" }, { label: "Main Boom", value: "90m" }, { label: "JIB", value: "86m" }, { label: "Total Reach", value: "270m" }] },
  { name: "700T Heavy Lift Crane", desc: "Maximum capacity all terrain telescopic crane for the most demanding infrastructure, port and industrial projects pan-India.", specs: [{ label: "Capacity", value: "700T" }, { label: "Main Boom", value: "100m+" }, { label: "Drive", value: "All-Wheel" }, { label: "Deployment", value: "Pan-India" }] },
];

const applications = [
  "Bridge construction and segment lifting",
  "Power plant equipment erection",
  "Heavy industrial machinery installation",
  "High-rise building construction",
  "Port and JNPT area operations",
  "Transformer and reactor lifting",
  "Infrastructure and civil engineering",
  "Oil & gas and petrochemical plants",
  "Wind turbine erection",
  "Pan-India mega project deployments",
];
